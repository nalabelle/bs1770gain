...
///////////////////////////////////////////////////////////////////////////////
...
#if defined (_WIN32) // [
  #define __PBU_WFILE__ pbu_wbasename(L ## __FILE__)
  #define __pbu_wfunc__ L ## __func__
  #define PBU_WERROR(m) L"Error " m ": %s(), \"%s\" (%d).\n"
#endif // ]
  ...
  #define PBU_DMESSAGEV(m,...) \
      fprintf(stderr,PBU_ERROR(m),__VA_ARGS__,__func__,__PBU_FILE__,__LINE__)
#if defined (_WIN32) // [
  #define PBU_DWMESSAGE(m) \
      fprintf(stderr,PBU_WERROR(m),__pbu_wfunc__,__PBU_WFILE__,__LINE__)
  #define PBU_DWMESSAGEV(m,...) \
      fprintf(stderr,PBU_WERROR(m),__VA_ARGS__,__pbu_wfunc__,__PBU_WFILE__, \
      __LINE__)
#endif // ]
#endif // ]
